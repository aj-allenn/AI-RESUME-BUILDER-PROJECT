...
const ColorPicker = ({selectedColor,onChange}) => {
  ...
  return (
    <div className='relative'>
        ...
        bg-gradient-to-br from-purple-200 to-purple-300 ring-purple-300 
                ...
                {colors.map((color)=>(
                    ...
                    onClick={()=> {onChange(color.value); setIsOpen(false)}}>
                        ...
                        {selectedColor === color.value && (
                            <div className='absolute top-0 left-0 right-0 bottom-4.5 flex item-center justify-center'>
                                <CheckIcon className="size-5 ttext-white"/>
                            </div>
