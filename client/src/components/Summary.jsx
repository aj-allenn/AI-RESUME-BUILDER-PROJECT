    ...
    <div className='space-y-4'>
        <div className='flex items-center justify-between'>
            ...
            <button
              ...
              disabled={enhancing}
              className='flex items-center gap-2 px-3 py-1 text-sm bg-purple-100 text-purple-700 rounded hover:bg-purple-200 dark:hover:bg-purple-500/30 transition-colors disabled:opacity-50'
            >
        ...
        <div className='mt-6'>
            <textarea value={data || ""}
             ...
             className='w-full p-3 px-4 mt-2 border text-sm border-gray-300 bg-white text-slate-700 rounded-lg
             ...
             <p className="text-gray-600 text-sm mt-1">Tip: Keep it concise (3-4 sentences) and focus on your most relevant achievements and skills.</p>
        </div>
