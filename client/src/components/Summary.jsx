  ...
  return (
    <div className='space-y-4'>
        <div className='flex items-center justify-between'>
            <div>
                <h3 className='flex item-center gap-2 text-lg font-semibold text-gray-900 dark:text-gray-100'>Professional Summary</h3>
                <p className='text-sm text-gray-500 dark:text-gray-400'>Add summary for your resume here</p>
            </div>
            <button
        ...
        <div className='mt-6'>
            <textarea value={data || ""}
             ...
             className='w-full p-3 px-4 mt-2 border text-sm border-gray-300 dark:border-gray-600 bg-white dark:bg-slate-800 text-gray-900 dark:text-white rounded-lg
             ...
             <p className="text-gray-600 dark:text-gray-400 text-sm mt-1">Tip: Keep it concise (3-4 sentences) and focus on your most relevant achievements and skills.</p>
        </div>
