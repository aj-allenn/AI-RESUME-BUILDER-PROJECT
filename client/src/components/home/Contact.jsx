...
const Contact = () => {
  return (
    <>
     <div id='cta' className='border-y border-dashed border-slate-200 w-full max-w-5xl mx-auto px-10 sm:px-16 mt-30'>
            <div className="flex flex-col md:flex-row text-center md:text-left items-center justify-between gap-8 px-3 md:px-10 border-x border-dashed border-slate-200 py-16 sm:py-20 -mt-10 -mb-10 w-full">
                ...
                <a href="https://prebuiltui.com" className="flex items-center gap-2 rounded py-3 px-8 bg-[#9648ca] hover:bg-[#f6916d] transition text-white">
