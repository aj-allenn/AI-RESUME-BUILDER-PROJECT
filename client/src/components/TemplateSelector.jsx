import { CheckIcon, LayoutIcon } from 'lucide-react'
    ...
    const templates = [
        ...
        // },
        ...
        },
         {
            id:"minimal-image",
            name:"Minimal Image",
            preview:"Minimal design with a single image an clean typography"
        },
    ]
  return (
            ...
            <div key={template.id} onClick={()=>{
                ...
                {selectedTemplate === template.id &&(
                    ...
                    <div className='space-y-1'>
                        <h4 className='font-medium text-gray-800 dark:text-gray-'>{template.name}</h4>
