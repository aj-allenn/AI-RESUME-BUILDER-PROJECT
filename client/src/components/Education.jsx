  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h3 className="flex items-center gap-2 text-lg font-semibold text-gray-900 dark:text-gray-100">Education</h3>
          ...
          {data.map((education, index) => (
            <div key={index} className="p-4 border border-gray-200 dark:border-gray-700 rounded-lg space-y-3">
              <div className="flex justify-between items-start">
                <h4 className="dark:text-gray-200">Education #{index + 1}</h4>
                <button
              ...
              <div className="grid md:grid-cols-2 gap-3">
                ...
                <input
                  ...
                  className="px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 bg-white dark:bg-slate-800 text-gray-900 dark:text-white rounded-lg disabled:bg-gray-100 dark:disabled:bg-slate-700/50 focus:ring-2 focus:ring-purple-500 focus:border-purple-500 outline-none"
                />
              </div>
              ...
              <label className="flex items-center gap-2">
                <input
                  ...
                  className="rounded border-gray-300 dark:border-gray-600 dark:bg-slate-800 text-purple-600 focus:ring-purple-500"
                />
