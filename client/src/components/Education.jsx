          ...
          {data.map((education, index) => (
            <div key={index} className="p-4 border border-gray-200 rounded-lg space-y-3">
              <div className="flex justify-between items-start">
                <h4 className="text-gray-500">Education #{index + 1}</h4>
                <button
              ...
              <div className="grid md:grid-cols-2 gap-3">
                ...
                <input
                  ...
                  className="px-3 py-2 text-sm border border-gray-300 bg-white text-gray-900 rounded-lg disabled:bg-gray-100 focus:ring-2 focus:ring-purple-500 focus:border-purple-500 outline-none"
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full text-sm px-3 py-2 border border-gray-300 bg-white text-gray-800 rounded-lg resize-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 outline-none"
