  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-100 via-purple-100 to-pink-100 px-4">
      <form
        ...
        className="w-[350px] h-md max-w-md bg-white rounded-2xl shadow-2xl px-3 py-5"
      >
        {/* Header */}
     ...
     <a
        ...
        className="flex items-center justify-center gap-3 w-full mt-3 border border-gray-300 py-3 rounded-lg hover:bg-gray-100 transition"
      >
       <svg
        viewBox="0 0 24 24"
        fill="currentColor"
     ...
     {/* Submit */}
        <button
          type="submit"
          className="w-full mt-6 bg-indigo-500 text-white py-3 rounded-lg font-medium hover:bg-indigo-600 transition"
        >
